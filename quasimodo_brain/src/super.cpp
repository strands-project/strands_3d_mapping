...
exit(0);
	...
	ne.setNormalEstimationMethod (ne.AVERAGE_3D_GRADIENT);//ne.AVERAGE_DEPTH_CHANGE );//ne.AVERAGE_3D_GRADIENT);
	ne.setMaxDepthChangeFactor(1.5f);
  ...
  PointCloudT::Ptr voxel_centroid_cloud = super.getColoredCloud();
