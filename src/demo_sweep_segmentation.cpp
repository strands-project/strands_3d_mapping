...
int main(int argc, char** argv)
{
    ...
    string sweep_path(argv[1]);

    CloudT::Ptr cloud = semantic_map_load_utilties::loadMergedCloudFromSingleSweep<PointT>(sweep_path);
    ...
    Graph* g = ss.compute_convex_oversegmentation(supervoxels, filtered_cloud, true);
